...
?>
    <a class="btn add_wishlist hasTooltips <?php echo in_array($product->virtuemart_product_id, $wishlistIds) ? 'act' : ''; ?>"
...
<?php
  ...
  $whishlistBD = isset($allprod['id']) ? $allprod['id'] : array();
    ?>
    <a class="btn add_wishlist hasTooltips <?php echo in_array($product->virtuemart_product_id, $whishlistBD) ? 'act' : ''; ?>"
       title="<?php echo JText::_('ADD_TO_WHISHLIST'); ?>"
       onclick="TmboxAddToWishlist('<?php echo $product->virtuemart_product_id; ?>');">
        <i class="material-icons-favorite"></i>
        <span><?php echo JText::_("ADD_TO_WHISHLIST"); ?></span>
