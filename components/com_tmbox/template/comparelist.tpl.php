...
//var_dump($compareIds);
?>        
<a class="btn add_compare hasTooltips <?php echo in_array($product->virtuemart_product_id, $compareIds) ? 'act' : ''; ?>"
   title="<?php echo JText::_('ADD_TO_COMPARE'); ?>"
   onclick="TmboxAddToCompare('<?php echo $product->virtuemart_product_id; ?>');">
