...
if(!ACYMAILING_J16){
	...
	class JElementTermscontent extends JElement
	{
		...
		function fetchElement($name, $value, &$node, $control_name)
		{
			...
			$text .= '<a class="modal" id="termscontent" title="Select one content which will be displayed for the Terms & Conditions"  href="'.$link.'" rel="{handler: \'iframe\', size: {x: 650, y: 375}}"><button class="btn" onclick="return false">'.acymailing_translation('SELECT').'</button></a>';
