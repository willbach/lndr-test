...
class KomentoComment extends JObject
{
	...
	public function delete()
	{
		...
		$args = array('component' => $this->component, 'cid' => $this->cid, 'comment' => &$this);
		$result = Komento::trigger('onBeforeDeleteComment', $args);
		...
		Komento::trigger('onAfterDeleteComment', $args);

		// Always move child up regardless of deleting child or not
		$model = Komento::getModel('Comments');
		$model->moveChildsUp($this->id);
		...
		// Process activities
		Komento::getHelper('activity')->process('remove', $this->id);

		// Delete attachments for the comment
