...
<tr id="kpost-toolbar" class="krow<?php echo 1 + $this->k^=1;?>">
	<td class="kcol-first kcol-editor-label hidden-tablet hidden-phone">
	...
	<table class="kpostbuttonset">
		...
		<tr>
			...
			<div id="kbbcode-link-options" style="display: none;">
				...
				<button class="btn btn-primary" type="button" name="insterLink" value="<?php echo JText::_('COM_KUNENA_EDITOR_INSERT'); ?>"
					...
					onmouseover="document.id('helpbox').set('value', '<?php echo JText::_('COM_KUNENA_EDITOR_HELPLINE_LINKAPPLY', true); ?>')"><?php echo JText::_('COM_KUNENA_EDITOR_INSERT'); ?></button>
			</div>
			...
			<div id="kbbcode-image-options" style="display: none;">
				...
				<button class="btn btn-primary" type="button" name="Link" value="<?php echo JText::_('COM_KUNENA_EDITOR_INSERT'); ?>" onclick="kInsertImageLink()"
					onmouseover="document.id('helpbox').set('value', '<?php echo JText::_('COM_KUNENA_EDITOR_HELPLINE_IMAGELINKAPPLY', true); ?>')"><?php echo JText::_('COM_KUNENA_EDITOR_INSERT'); ?></button>
			</div>
			...
			<div id="kbbcode-code-options" style="display: none;">
				<?php echo $codeTypes; ?>
				<button id="kbutton_addcode" class="btn btn-primary" type="button" name="Code" onclick="kInsertCode()" value="<?php echo JText::_('COM_KUNENA_EDITOR_CODE_INSERT'); ?>"
					onmouseover="document.id('helpbox').set('value', '<?php echo JText::_('COM_KUNENA_EDITOR_HELPLINE_CODEAPPLY', true); ?>')"><?php echo JText::_('COM_KUNENA_EDITOR_CODE_INSERT'); ?></button>
			</div>
			<?php endif;
			...
			?><input id="kvideoid"
				...
				?>')" />
			<button id="kbutton_addvideo1" class="btn btn-primary" type="button" name="Video" accesskey="p"
				onclick="kInsertVideo1()"
				value="<?php echo JText::_('COM_KUNENA_EDITOR_VIDEO_INSERT'); ?>"
				onmouseover="document.id('helpbox').set('value', '<?php
				echo JText::_('COM_KUNENA_EDITOR_HELPLINE_VIDEOAPPLY1', true);
				?>')"><?php echo JText::_('COM_KUNENA_EDITOR_VIDEO_INSERT'); ?></button><br />
			<?php
			...
			?><input id="kvideourl" name="videourl"
				...
				?>')" />
			<button id="kbutton_addvideo2" class="btn btn-primary" type="button" name="Video" accesskey="p"
				onclick="kInsertVideo2()"
				value="<?php echo JText::_('COM_KUNENA_EDITOR_VIDEO_INSERT'); ?>"
				onmouseover="document.id('helpbox').set('value', '<?php
				echo JText::_('COM_KUNENA_EDITOR_HELPLINE_VIDEOAPPLY2', true);
				?>')"><?php echo JText::_('COM_KUNENA_EDITOR_VIDEO_INSERT'); ?></button>
			</div>
			</td>
		</tr>
		<?php
		...
		<tr>
			<td class="kposthint"><textarea name="helpbox" id="helpbox" class="kinputbox" disabled="disabled"><?php echo (JText::_('COM_KUNENA_EDITOR_HELPLINE_HINT')); ?></textarea></td>
		</tr>
	</table>
	</td>
</tr>
...
<tr id="kpost-message" class="krow<?php echo 1 + $this->k^=1;?>">
	<td class="kcol-first kcol-editor-label hidden-tablet hidden-phone"><strong><?php
