...
?>
	<ul id="kpost-profiletop">
		...
		<?php endif ?>
		<?php if($this->profile->isOnline()) : ?>
		<li><span class="kicon-button kbuttononline-yes"><span class="online-yes"><span><?php echo JText::_('COM_KUNENA_ONLINE'); ?></span></span></span></li>
