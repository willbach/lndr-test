...
<ul class="nav nav-tabs <?php echo $this->class_sfx;?>"<?php echo ($this->parameters->get('tag_id')) ? " id=\"{$this->parameters->get('tag_id')}\"" : '' ?>>
<?php
foreach ($this->list as $i => $item) :
	...
	if ($item->type == 'separator' || $item->id == $this->active_id) {
