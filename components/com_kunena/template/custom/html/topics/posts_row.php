...
<tr class="<?php echo $this->getTopicClass('k', 'row') ?>">
	<td class="kcol-first kcol-ktopicicon hidden-phone<?php if (strpos($this->topic->getIcon(),'unanswered')) echo ' unanswered'; ?>">
...
// FIXME:
	...
	<td class="kcol-mid ktopictittle hidden-phone">
		<div class="ktopic-title-cover">
			<?php
...
<?php if (!empty($this->postActions)) : ?>
	<td class="kcol-mid ktopicmoderation"><input class ="kcheck" type="checkbox" name="posts[<?php echo $this->message->id?>]" checked="checked" /></td>
<?php endif; ?>
</tr>
<?php if ($this->module) : ?>
<tr>
