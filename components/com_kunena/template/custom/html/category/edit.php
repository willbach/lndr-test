...
<div class="kblock kmanage">
	...
	<div class="kcontainer">
		...
		<div class="kbuttons">
			<button class="btn btn-primary" onclick="submitbutton('save')"><?php echo JText::_( 'Save' ); ?></button>
			<button class="btn btn-primary" onclick="submitbutton('cancel')"><?php echo JText::_( 'Cancel' ); ?></button>
		</div>
		<?php
		...
		<fieldset>
			...
			<?php echo JHtml::_('tabs.panel', JText::_('COM_KUNENA_PERMISSIONS'), 'panel_catperms'); ?>
				<fieldset>
					...
					<table class="kadmin-adminform">
						<tr>
							<td class="nowrap" width="25%"><?php echo JText::_('COM_KUNENA_A_ACCESSTYPE_TITLE'); ?></td>
							<td width="25%"><?php echo $this->options ['accesstypes']; ?></td>
						...
						<tr class="kaccess kaccess-<?php echo $accesstype ?>" style="<?php echo $this->category->accesstype != $accesstype ? 'display:none' : '' ?>">
							<td class="nowrap"><?php echo $accessinput['title'] ?></td>
