...
<div class="kblock">
	<div class="kheader">
		<span><?php echo JText::_('COM_KUNENA_FORUM_HEADER'); ?></span>
	</div>
...
<?php if ($this->displayCategoryActions() || $this->getPagination (7)) : ?>
				...
				<table class="kblocktable<?php echo $this->escape($this->category->class_sfx); ?>" id="kflattable">
					...
					<tr class="krow1">
						<td colspan="<?php echo empty($this->topicActions) ? 5 : 6 ?>" class="kcol krowmoderation">
							...
							<button type="submit" name="kcheckgo" class="btn btn-primary" value="<?php echo JText::_('COM_KUNENA_GO') ?>" ><?php echo JText::_('COM_KUNENA_GO') ?></button>
							<?php endif; ?>
						</td>
					</tr>
					<!-- /Bulk Actions -->
