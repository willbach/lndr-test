...
$document->addStyleSheet('templates/'.$template.'/css/camera.css');
 ...
 ?>
<div id="camera-slideshow_<?php echo $module->id; ?>" class="<?php echo $moduleclass_sfx; ?> camera_wrap pattern_<?php echo $params->get('pattern'); ?>" style="height: <?php echo $params->get('height'); ?>">
<?php
	// Item URL
