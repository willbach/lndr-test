...
$print_twitter = '';
$print_twitter .= '<a class="twitter-timeline" data-theme="'.$widgetTheme.'" data-link-color="'.$linkColor.'" data-border-color="'.$borderColor.'" data-chrome="'.$footer.$border.$scrollbar.' transparent" href="https://twitter.com/'.$userName.'" data-widget-id="'.$widgetId.'" width="'.$width.'" height="'.$height.'">Tweets by @'.$userName.'</a>';
?>
