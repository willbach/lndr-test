...
<div class="mod_caroufredsel mod_caroufredsel__<?php echo $moduleclass_sfx; ?>" id="module_<?php echo $module->id; ?>">
	...
	<?php if ($params->get('navigation') && $key>0): ?>
		<div id="carousel_<?php echo $module->id; ?>_prev" class="caroufredsel_prev"><i class="fa fa-angle-left"></i></div>
		<div id="carousel_<?php echo $module->id; ?>_next" class="caroufredsel_next"><i class="fa fa-angle-right"></i></div>
	<?php endif; ?>
