...
<div class="mod-newsflash-adv features mod-newsflash-adv__<?php echo $moduleclass_sfx; ?> cols-<?php echo $columns; ?>" id="module_<?php echo $module->id; ?>">
  ...
  foreach ($list as $key => $item){
    ...
    if($rows > 1 && $key !== 0 && $key % $columns == 0 && !$params->get('masonry')){
      echo '</div><div class="row-fluid">';
    }
  ?>
  <article class="<?php echo $spanClass; ?> item item_num<?php echo $key; ?> item__module  <?php echo $class; ?>" id="item_<?php echo $item->id; ?>">
