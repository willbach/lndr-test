...
?>
<section class="page-blog page-blog__<?php echo $this->pageclass_sfx;?> page-blog-<?php echo (int) $this->columns;?>-columns<?php if(!empty($this->lead_items)) echo ' blog-leading'; ?>" itemscope itemtype="http://schema.org/Blog">
	...
	<div class="items-leading">
		...
		<article class="leading-<?php echo $leadingcount; ?><?php echo $item->state == 0 ? ' system-unpublished' : null; ?> item" id="item-<?php echo $item->id; ?>">
			<?php
			$this->item = &$item;
			echo $this->loadTemplate('item-leading');
			?>
		</article>
