...
<?php     $rows = 4;
          if($this->_config->get('jg_smiliesupport')):
            ...
            <div class="input_wrapper"><textarea required cols="40" rows="<?php echo $rows; ?>" name="cmttext" class="inputbox" tabindex="100" placeholder="<?php echo JText::_('COM_JOOMGALLERY_COMMON_COMMENT'); ?>"><?php echo $this->_mainframe->getUserState('joom.comments.text'); ?></textarea></div>
