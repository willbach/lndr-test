...
if(Vmconfig::get('multix','none')!=='none' || $this->lists['custnumber'] || $user->authorise('core.admin','com_virtuemart') || $this->lists['shoppergroups']){ ?>
...
<?php } ?>
<?php
	if($this->lists['custnumber'] || $user->authorise('core.admin','com_virtuemart')){ ?>
		<tr>
			<td class="key">
