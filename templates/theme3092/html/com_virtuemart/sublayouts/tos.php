...
echo VmHtml::checkbox ($_prefix.$field['name'], $tos, 1, 0, 'class="terms-of-service required"', 'tos'); ?>
	<label for="tos">
		...
		<a href="<?php echo JRoute::_ ('index.php?option=com_virtuemart&view=vendor&layout=tos&virtuemart_vendor_id=1', FALSE) ?>" class="terms-of-service" id="terms-of-service" rel="facebox" target="_blank"><?php echo vmText::_ ('COM_VIRTUEMART_CART_TOS') ?></a>.
	</label>
