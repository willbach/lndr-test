...
class statusfilterlistType{
	...
	function __construct(){
		$this->values = array();
		$this->values[] = JHTML::_('select.option', '1', acymailing_translation('SUBSCRIBERS') );
		$this->values[] = JHTML::_('select.option', '2', acymailing_translation('PENDING_SUBSCRIPTION') );
		$this->values[] = JHTML::_('select.option', '-1', acymailing_translation('UNSUBSCRIBERS') );
		$this->values[] = JHTML::_('select.option', '-2', acymailing_translation('NO_SUBSCRIPTION') );
	}
