...
class plgAcymailingTaguser extends JPlugin{
	...
	function acymailingtaguser_show(){
		...
		<?php
		$typeinfo = array();
		$typeinfo[] = JHTML::_('select.option', "receiver", acymailing_translation('RECEIVER_INFORMATION'));
		$typeinfo[] = JHTML::_('select.option', "sender", acymailing_translation('SENDER_INFORMATIONS'));
