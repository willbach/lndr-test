			...
			<table cellspacing="1" width="100%">
				...
				<tr>
					...
					<td>
						...
						echo ' <a class="modal" title="'.acymailing_translation('ACY_EDIT', true).'"  href="index.php?option=com_acymailing&amp;tmpl=component&amp;ctrl=subscriber&amp;task=choose&amp;onlyreg=1" rel="{handler: \'iframe\', size: {x: 800, y: 500}}"><img class="icon16" src="'.ACYMAILING_IMAGES.'icons/icon-16-edit.png" alt="'.acymailing_translation('ACY_EDIT', true).'"/></a>';
						?>
					</td>
				</tr>
				<tr>
