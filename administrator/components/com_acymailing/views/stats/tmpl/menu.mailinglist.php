...
?><fieldset class="acyheaderarea">
	...
	<div class="toolbar" id="toolbar" style="float: right;">
		<table>
			<tr>
				<td><a href="<?php echo acymailing_completeLink(JRequest::getCmd('ctrl').'&task=mailinglist&export=1&mailid='.JRequest::getInt('mailid'), true); ?>"><span class="icon-32-acyexport" title="<?php echo acymailing_translation('ACY_EXPORT', true); ?>"></span><?php echo acymailing_translation('ACY_EXPORT'); ?></a></td>
