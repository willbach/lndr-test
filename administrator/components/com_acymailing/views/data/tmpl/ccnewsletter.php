...
if(!empty($resultLists)){
	...
	echo acymailing_translation_sprintf('IMPORT_LIST_TOO', 'ccNewsletter').JHTML::_('acyselect.booleanlist', "ccNewsletter_lists");
	echo '</div>';
}
if(!empty($resultNews)){
	echo '<div class="acyblockoptions"><span class="acyblocktitle">'.acymailing_translation_sprintf('LISTS_IN_COMP', $resultLists, 'ccNewsletter').'</span>';
	echo acymailing_translation_sprintf('IMPORT_NEWSLETTERS_TOO', 'ccNewsletter').JHTML::_('acyselect.booleanlist', "ccNewsletter_news");
}
