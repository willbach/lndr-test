	...
	<form action="index.php?option=<?php echo ACYMAILING_COMPONENT ?>&amp;ctrl=template" method="post" name="adminForm" id="adminForm">
		...
		<table class="acymailing_table" cellpadding="1" id="templateListing">
			...
			<tr>
				...
				<th class="title">
					<?php echo JHTML::_('grid.sort', acymailing_translation('ACY_TEMPLATE'), 'a.name', $this->pageInfo->filter->order->dir, $this->pageInfo->filter->order->value); ?>
				</th>
				<?php if(!ACYMAILING_J30){ ?>
				...
				<th class="title titletoggle">
					<?php echo JHTML::_('grid.sort', acymailing_translation('ACY_DEFAULT'), 'a.premium', $this->pageInfo->filter->order->dir, $this->pageInfo->filter->order->value); ?>
				</th>
				<th class="title titletoggle">
				...
				<th class="title titleid">
					<?php echo JHTML::_('grid.sort', acymailing_translation('ACY_ID'), 'a.tempid', $this->pageInfo->filter->order->dir, $this->pageInfo->filter->order->value); ?>
				</th>
			</tr>
			</thead>
			<tfoot>
