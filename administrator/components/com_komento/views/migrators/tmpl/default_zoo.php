...
<div id="migrator-zoo" migrator-type="zoo" migration-type="article" class="noshow migratorTable">
	<div class="row">
		<div class="col-md-6">
...
<?php } else { ?>
<div id="migrator-zoo" class="noshow adminlist">
	<div class="row">
		<div class="col-md-6">
			<fieldset class="panel">
				<div class="panel-body">
					<?php echo JText::_( 'COM_KOMENTO_ZOO_NOT_INSTALLED' ); ?>
				</div>
			</fieldset>
		</div>
	</div>
