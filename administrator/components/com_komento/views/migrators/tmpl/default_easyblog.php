...
?>
<div id="migrator-easyblog" migrator-type="easyblog" migration-type="article" class="noshow migratorTable">
	<div class="row">
		<div class="col-md-6">
		...
		<div class="col-md-6 migratorProgress">
...
<div id="migrator-easyblog" class="noshow adminlist">
	<div class="row">
		<div class="col-md-6">
			<fieldset class="panel">
				<div class="panel-body">
					<?php echo JText::_( 'COM_KOMENTO_EASYBLOG_NOT_INSTALLED' ); ?>
				</div>
			</fieldset>
		</div>
	</div>
