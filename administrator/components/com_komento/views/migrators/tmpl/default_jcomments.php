...
<div id="migrator-jcomments" migrator-type="jcomments" migration-type="component" class="noshow migratorTable">
	<div class="row">
		<div class="col-md-6">
...
<?php } else { ?>
<div id="migrator-jcomments" class="noshow adminlist">
	<div class="row">
		<div class="col-md-6">
			<fieldset class="panel">
				<div class="panel-body">
					<?php echo JText::_( 'COM_KOMENTO_JCOMMENTS_NOT_INSTALLED' ); ?>
				</div>
			</fieldset>
		</div>
	</div>
