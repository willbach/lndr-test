	...
	<div class="span12">
		<div class="span6">
			<fieldset class="panel form-horizontal">
				<div class="panel-head"><?php echo JText::_( 'COM_KOMENTO_SETTINGS_PROFILE' ); ?></div>
			...
			<fieldset class="panel form-horizontal">
				<div class="panel-head"><?php echo JText::_( 'COM_KOMENTO_SETTINGS_PROFILE_TAB' ); ?></div>
				<div class="panel-body">
						<!-- Show Comments Tab -->
			...
			<fieldset class="panel form-horizontal">
				<div class="panel-head"><?php echo JText::_( 'COM_KOMENTO_SETTINGS_PROFILE_SETTINGS' ); ?></div>
				<div class="panel-body">
		...
		<div class="span6">
			<fieldset class="panel form-horizontal">
				<div class="panel-head"><?php echo JText::_( 'COM_KOMENTO_SETTINGS_PROFILE_ACTIVITIES' ); ?></div>
				<div class="panel-body">
						<!-- Show Comments -->
